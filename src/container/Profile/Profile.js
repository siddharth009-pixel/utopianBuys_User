                        ...
                        <div class="card">
                            <div class="card-body">
                                <nav class="nav flex-column nav-pills nav-gap-y-1">
                                    <a onClick={(e) => { e.preventDefault(); setProfileInfo(true); setAddress(false); setSecurity(false); setNotification(false); setBilling(false) }} data-toggle="tab" class={`nav-item nav-link has-icon nav-link-faded ${profileInfo ? 'active' : ''}`}>
                                    ...
                                    <a onClick={(e) => { e.preventDefault(); setProfileInfo(false); setAddress(true); setSecurity(false); setNotification(false); setBilling(false) }} data-toggle="tab" class={`nav-item nav-link has-icon nav-link-faded ${address ? 'active' : ''}`}>
                                    ...
                                    <a onClick={(e) => { e.preventDefault(); setProfileInfo(false); setAddress(false); setSecurity(true); setNotification(false); setBilling(false) }} data-toggle="tab" class={`"nav-item nav-link has-icon nav-link-faded ${security ? 'active' : ''}`}>
                                    ...
                                    <a onClick={(e) => { e.preventDefault(); setProfileInfo(false); setAddress(false); setSecurity(false); setNotification(true); setBilling(false) }} data-toggle="tab" class={`nav-item nav-link has-icon nav-link-faded ${notification ? 'active' : ''}`}>
                                    ...
                                    <a onClick={(e) => { e.preventDefault(); setProfileInfo(false); setAddress(false); setSecurity(false); setNotification(false); setBilling(true) }} data-toggle="tab" class={`nav-item nav-link has-icon nav-link-faded ${billing ? 'active' : ''}`}>
